...
const Featured = async () => {
    ...
    return (
        <div className='my-10 '>
            <h1 className='text-center font-bold text-5xl not-md:text-3xl mb-3'>FEATURED ANIMALS</h1>
            <p className='text-2xl not-md:text-md text-center mb-7'>Featuring animals for Qurbani</p>
